 ...
 *
 * Background fades in, then text slides up with a staggered subtext reveal.
 * A subtle scale pulse draws attention to the main text after it settles.
 */
export const Outro: React.FC<OutroProps> = ({
  ...
  // Main text: slide up from 60px, starting 5 frames after bg
